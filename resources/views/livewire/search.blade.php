<div
    class="bg-white flex items-center self-stretch rounded-lg"
    :class="{'rounded-bl-none': dropdownOpened}"
    x-data="{
...
>
    <div class="relative flex items-center self-stretch flex-grow">
