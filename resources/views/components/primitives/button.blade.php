...
@php
    $themeClasses = [
        ...
        'link' => 'px-0 text-sm text-global-blue fill-global-blue hover:text-link-hover hover:fill-link-hover',
    ];
    $iconSizeClasses = [
        'small' => 'w-4 h-4',
        'medium' => 'w-6 h-6',
...
<button {{ $attributes->merge(['class' => "transition-colors duration-200 flex items-center space-x-3 {$themeClass}"]) }}>
    @isset($icon)
